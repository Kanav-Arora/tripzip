...
const Card = ({ Icon, title, description }) => {
    ...
    useEffect(() => {
        if (inView) {
            controls.start({ opacity: 1, x: 0, transition: { duration: 0.5, delay: 0.3 } });
        }
    }, [controls, inView]);
...
export default function SectionB() {
    ...
    const steps = [
        ...
        {
            title: 'Explore trips',
            description: 'Explore trips hosted by others and get info on itinerary, budget, group members',
        },
        {
            title: 'Make a request',
            description: 'Connect with the host, make plans and make a request to join',
        },
        {
    ...
    return (
        <div className='my-28 mx-40 flex flex-row gap-x-10'>
            ...
            <div className='w-3/5 flex flex-col'>
                ...
                <div className='text-black text-4xl font-bold pl-4 mb-5'>One click for you</div>
                <div className="flex-grow overflow-y-auto" ref={scrollRef} onScroll={handleScroll}>
